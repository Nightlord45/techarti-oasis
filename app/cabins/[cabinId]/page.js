...
const Page = async ({ params }) => {
  ...
  return (
    <div className="mx-auto mt-8 max-w-6xl">
      <div
        className="border-primary-800 mb-24 grid grid-cols-[3fr_4fr] gap-20
          border px-10 py-3"
      >
        ...
        <div>
          <h3
            className="text-accent-100 bg-primary-950 mb-5 w-[150%]
              translate-x-[-254px] p-6 pb-1 text-7xl font-black"
          >
            Cabin {name}
          </h3>
